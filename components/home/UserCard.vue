    ...
    <div class="px-8 max-w-[1152px] mx-auto w-full border-0 box-border">
      <div class="flex flex-row items-center justify-between relative z-10 border-0 box-border">
        <div class="w-full md:w-[60%] mt-0 order-1 md:order-1 mb-0 flex-1 max-w-[576px] border-0 box-border">
          <p
            class="text-lg leading-7 text-[#5068e2] inline-block font-semibold relative break-words whitespace-normal m-0 border-0 box-border">
          ...
          <h1
            ...
            Building
            <span class="text-[#2a3b90] relative z-10 border-0 box-border">impactful</span>
            digital solutions
          </h1>
          ...
          <div class="flex flex-row gap-4 mt-6 mb-8 border-0 box-border">
            <nuxt-link to="/projects"
              class="shadow-md hover:shadow-lg items-center bg-[#2a3b90] rounded-full text-white flex font-medium gap-2 justify-center transition-all duration-300 ease-in-out text-center py-3 px-8 no-underline border-0 box-border">
              <UIcon name="i-uil:eye" />
              View My Work
            </nuxt-link>
            <nuxt-link to="/about"
              class="items-center border-2 border-[#2a3b90] rounded-full text-[#2a3b90] flex font-medium gap-2 justify-center transition-all duration-300 ease-in-out text-center py-3 px-8 no-underline box-border">
